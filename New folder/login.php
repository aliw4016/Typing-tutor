...
VALUES ('$accu', '$net', '$tkk','$active')";
         ...
         header("location:http://localhost/fyp/index.html");
      }
       else 
       {
         ?>
...
<div class="col-xs-6 col-md-4 col-centered">
  <div class="form-group" >
	...
	<input type="submit" id="signin" value="Sign In" class="btn btn-default center-block colourtwo " name="Sign Up" style="background-color: #E0F7FA "/>
  <div>
